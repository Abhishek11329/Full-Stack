...
public class SecurityConfig {
    ...
    public SecurityConfig(CustomUserDetailsService userDetailsService, AuthEntryPointJwt unauthorizedHandler, JwtAuthFilter jwtAuthFilter) {
